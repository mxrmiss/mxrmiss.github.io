...
<%- partial('_partial/prismjs', { post: page }) %>

<div class="bg-dark-floor" style="position: fixed;left: 0;top: 0;width: 100%;height: 100%;z-index: -1;"></div>
<%- partial('_partial/bgSwiper', { post: page }) %>
...
<div class="row justify-position">
      ...
      <% if(page.comments !== false ) { %>
        <div id="myComment">
          <% if(theme.valine.on === true ) { %>
            <%- partial('_partial/comment/valine', { post: page }) %>
          <% } else if(theme.twikoo.on === true) { %>
            <%- partial('_partial/comment/twikoo') %>
  ...
  <%- partial('_partial/scripts/issues') %>
</div>
